...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kaka — todos & habits" },
      { name: "description", content: "Kaka is an AI-first todo and habit tracker you run yourself — capture in plain language, morning picks, daily pillars, streaks, reminders, and a weekly review." },
      { property: "og:title", content: "Kaka — todos & habits" },
      { property: "og:description", content: "An AI-first todo and habit tracker you run yourself." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Kaka — todos & habits" },
      { name: "twitter:description", content: "An AI-first todo and habit tracker you run yourself." },
    ],
    links: [
      {
        rel: "stylesheet",
...
// Runs before hydration so there's no flash of the wrong theme — sets the
